...
GIT_URL=https://github.com/mpaulgreen/gitops.git
GIT_REVISION=master
GIT_USER="mpaulgreen"
GIT_PASSWORD=""
...
IMAGE_NAME=quay.io/mpaulgreen/person-service
IMAGE_USER=mpaulgreen
IMAGE_PASSWORD=
...
command.help() {
  ...
  Examples:
      ...
      pipeline.sh build -u mpaulgreen -p <nope> [-t <target-namespace>]
